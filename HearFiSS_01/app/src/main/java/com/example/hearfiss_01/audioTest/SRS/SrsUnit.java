...
public class SrsUnit {
    ...
    public SrsUnit(int tu_id, int ts_id, String tu_Question, String tu_Answer, int tu_IsCorrect, int tu_dBHL, int tu_atId) {
        this.tu_id = tu_id;
        this.ts_id = ts_id;
    ...
    public SrsUnit(int ts_id, String tu_Question, String tu_Answer, int tu_IsCorrect, int tu_dBHL, int tu_atId) {
        this.ts_id = ts_id;
        this.tu_Question = tu_Question;
        this.tu_Answer = tu_Answer;
        this.tu_IsCorrect = tu_IsCorrect;
