...
public class WrsDesc02Activity extends AppCompatActivity
        implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {

    String m_TAG = "WrsDesc02Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrs_desc02);
        m_packname = getPackageName();

        Log.d(m_TAG, "onCreate");

        nextBtn = findViewById(R.id.imgBtnWrsDesc02Next);
...
//        super.onBackPressed();
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.imgBtnWrsDesc02Next) {
